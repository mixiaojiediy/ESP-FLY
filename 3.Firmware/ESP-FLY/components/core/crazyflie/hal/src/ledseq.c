...
// LED hardware removed - define empty macros for compatibility
#define LED_NUM 3
...
// LED hardware removed - empty functions
static inline void ledInit(void) {}
static inline void ledSet(led_t led, bool value) { (void)led; (void)value; }
static inline bool ledTest(void) { return true; }

// Additional LED definitions for compatibility
#define LED_BLUE_L LED_BLUE
