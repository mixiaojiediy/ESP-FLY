...
// LED hardware removed - define empty functions for compatibility
typedef enum {LED_BLUE = 0, LED_RED, LED_GREEN} led_t;
#define ERR_LED1 LED_RED
#define ERR_LED2 LED_RED
static inline void ledClearAll(void) {}
static inline void ledSet(led_t led, int value) { (void)led; (void)value; }
