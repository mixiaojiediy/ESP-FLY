...
#define MOT_PWM_CH1 2 // Motor M1 pwmchannel (LEDC channels 0-7 available on ESP32)
#define MOT_PWM_CH2 3 // Motor M2 pwmchannel
#define MOT_PWM_CH3 4 // Motor M3 pwmchannel
#define MOT_PWM_CH4 5 // Motor M4 pwmchannel
